...
},{"regenerator-runtime":"../../../../node_modules/regenerator-runtime/runtime.js"}],"../node_modules/waveform-data/lib/channel.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/waveform-data/lib/adapters/object.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/waveform-data/lib/adapters/arraybuffer.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/waveform-data/lib/core.js":[function(require,module,exports) {
"use strict";
...
},{"./channel":"../node_modules/waveform-data/lib/channel.js","./adapters/object":"../node_modules/waveform-data/lib/adapters/object.js","./adapters/arraybuffer":"../node_modules/waveform-data/lib/adapters/arraybuffer.js"}],"../node_modules/inline-worker/index.js":[function(require,module,exports) {
...
},{}],"../node_modules/waveform-data/lib/builders/audiodecoder.js":[function(require,module,exports) {
"use strict";
...
},{"../core":"../node_modules/waveform-data/lib/core.js","inline-worker":"../node_modules/inline-worker/index.js"}],"../node_modules/waveform-data/lib/builders/options.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/waveform-data/lib/builders/webaudio.js":[function(require,module,exports) {
"use strict";
...
},{"./audiodecoder":"../node_modules/waveform-data/lib/builders/audiodecoder.js","./options":"../node_modules/waveform-data/lib/builders/options.js"}],"../node_modules/waveform-data/waveform-data.js":[function(require,module,exports) {
"use strict";
...
},{"./lib/core":"../node_modules/waveform-data/lib/core.js","./lib/builders/webaudio":"../node_modules/waveform-data/lib/builders/webaudio.js"}],"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"components/Waveform.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    load: function load() {
      ...
      this.$api.get("pages/archive+the-signal-man/files").then(function (audio) {
        audio.data.forEach(function (child) {
          ...
          _this.items.push(audioFile);
        });
      });
    },
    selectAudio: function selectAudio(value) {
      var self, result, trackURL, audioContext;
      return _regenerator.default.async(function selectAudio$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              self = this;
              result = this.items.filter(function (obj) {
                return obj.value === value;
              });
              trackURL = result[0].url;
              ...
              fetch(trackURL).then(function (response) {
                ...
                var scaleY = function scaleY(amplitude, height) {
                  var range = 256;
                  var offset = 128;
...
exports.default = _default;
        var $e7aed3 = exports.default || module.exports;
      
      if (typeof $e7aed3 === 'function') {
        $e7aed3 = $e7aed3.options;
      }
    
        /* template */
        Object.assign($e7aed3, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "k-field",
    { staticClass: "waveform", attrs: { label: _vm.label } },
    [
      _c("k-input", {
        attrs: {
          theme: "field",
      ...
      _vm._v(" "),
      _vm.hasValue
        ? _c("k-text", { staticClass: "margin-top" }, [
            _vm._v("\n  Waveform loaded.\n")
          ])
        : _vm._e(),
      _vm._v(" "),
      _c("k-progress", { staticClass: "progress" }),
      _vm._v(" "),
      _c("div", { staticClass: "audioplayer" })
    ],
    1
  )
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e7aed3', $e7aed3);
          } else {
            api.reload('$e7aed3', $e7aed3);
          }
        }
...
},{"@babel/runtime/regenerator":"../../../../node_modules/@babel/runtime/regenerator/index.js","waveform-data":"../node_modules/waveform-data/waveform-data.js","_css_loader":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _Waveform = _interopRequireDefault(require("./components/Waveform.vue"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

panel.plugin("getkirby/pluginkit", {
  fields: {
    waveform: _Waveform.default
  }
});
},{"./components/Waveform.vue":"components/Waveform.vue"}],"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
