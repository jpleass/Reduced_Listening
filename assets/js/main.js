...
},{"outlayer":"../node_modules/outlayer/outlayer.js","get-size":"../node_modules/get-size/get-size.js"}],"../node_modules/infinite-scroll/js/core.js":[function(require,module,exports) {
var define;
// core
( function( window, factory ) {
  // universal module definition
...
},{}],"js/audioplayer/_waveform.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initWaveform = void 0;

var _wavesurfer = _interopRequireDefault(require("wavesurfer.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var initWaveform = function initWaveform(audioplayer) {
  var waveformJSON = audioplayer.dataset.waveform;
  return new Promise(function (resolve) {
    var track_URL = audioplayer.dataset.audio;
    var container = audioplayer.querySelector(".audioplayer__timeline");

    var waveform = _wavesurfer.default.create({
      container: container,
      waveColor: "#ccc",
      progressColor: "#333",
    ...
    fetch(waveformJSON).then(function (response) {
      if (!response.ok) {
...
exports.initWaveform = initWaveform;
},{"wavesurfer.js":"../node_modules/wavesurfer.js/dist/wavesurfer.js"}],"js/audioplayer/_time.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initTime = void 0;
...
var formatMillisecondsText = function formatMillisecondsText(milliseconds) {
  ...
  if (hours == 0) {
    ...
    return +hours + "hour " + (minutes < 10 ? '0' : '') + minutes + ' minutes, ' + (seconds < 10 ? '0' : '') + seconds + ' seconds.';
  }
};

var setDuration = function setDuration(waveform) {
  var durationEl = document.querySelector(".audioplayer__duration");
  var metaDuration = document.getElementById('LengthOfPiece');
  _audioplayer.AudioPlayer.audioDuration = waveform.getDuration();
  durationEl.innerText = secondsToMinutes(_audioplayer.AudioPlayer.audioDuration);

  if (metaDuration !== null) {
    metaDuration.innerText = formatMillisecondsText(_audioplayer.AudioPlayer.audioDuration * 1000);
  }
};

var setCurrent = function setCurrent(time) {
  var currentEl = document.querySelector(".audioplayer__current");
  currentEl.innerText = secondsToMinutes(time);
};

var initTime = function initTime(waveform) {
...
},{"./audioplayer":"js/audioplayer/audioplayer.js"}],"js/audioplayer/_playback.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initPlayback = exports.iconToPlay = exports.iconToPause = void 0;

var _audioplayer = require("./audioplayer");

var iconToPause = function iconToPause(icon) {
  icon.classList.remove("fa-play");
  icon.classList.add("fa-pause");
};

exports.iconToPause = iconToPause;

var iconToPlay = function iconToPlay(icon) {
  icon.classList.remove("fa-pause");
  icon.classList.add("fa-play");
};

exports.iconToPlay = iconToPlay;

var stateChange = function stateChange(waveform) {
  var projectHeaderIcon = document.querySelector('.project__header .audioplayer__flash');
  var audioPlayerIcon = document.querySelector('.audioplayer .audioplayer__play-state');
  waveform.isPlaying() ? iconToPause(audioPlayerIcon) : iconToPlay(audioPlayerIcon);

  if (_audioplayer.AudioPlayer.isArchive) {
    var archiveItemIcon = _audioplayer.AudioPlayer.activeArchive.querySelector('.archive__item__play i');
  ...
  if (projectHeaderIcon != null) {
    var projectHeaderStateChange = function projectHeaderStateChange() {
...
var initPlayback = function initPlayback(waveform) {
  waveform.on("seek", function (e) {
    // console.log(e) 
    waveform.play();
  });
  waveform.on("play", function (e) {
    stateChange(waveform);
  });
  ...
  waveform.on("audioprocess", function (e) {// console.log(e);
  }); // Play Buttons.

  document.querySelectorAll('.audioplayer__play').forEach(function (playButton) {
  ...
  document.querySelectorAll('.audioplayer__stop').forEach(function (playButton) {
    playButton.addEventListener('click', function (e) {
      e.preventDefault();
      waveform.stop();
    });
...
exports.initPlayback = initPlayback;
},{"./audioplayer":"js/audioplayer/audioplayer.js"}],"js/audioplayer/audioplayer.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initAudioPlayer = exports.AudioPlayer = void 0;

var _waveform = require("./_waveform");

var _time = require("./_time");

var _playback = require("./_playback");
...
var audioPlayer = /*#__PURE__*/function () {
  function audioPlayer(container, waveform, activeArchive, autoplay) {
  ...
  _createClass(audioPlayer, [{
    key: "init",
    value: function init() {
      (0, _time.initTime)(this.waveform);
      (0, _playback.initPlayback)(this.waveform);
...
var initAudioPlayer = function initAudioPlayer(audioplayer, activeArchive, autoplay) {
  ...
  exports.AudioPlayer = AudioPlayer = new audioPlayer(audioplayer, null, activeArchive, autoplay);
  loadingStateStyling();
  (0, _waveform.initWaveform)(audioplayer).then(function (waveform) {
...
var loadingStateStyling = function loadingStateStyling() {
...
var playingStateStyling = function playingStateStyling() {
...
},{"./_waveform":"js/audioplayer/_waveform.js","./_time":"js/audioplayer/_time.js","./_playback":"js/audioplayer/_playback.js"}],"js/_archive.js":[function(require,module,exports) {
"use strict";
...
var _audioplayer = require("./audioplayer/audioplayer");
...
var loadPagination = function loadPagination() {
  var infScroll = new _infiniteScroll.default(".archive", {
  ...
  infScroll.on('append', function (response, path, items) {
    msnry.appended(_toConsumableArray(items));
    initArchiveItems(archive.querySelectorAll('.archive__item'));
  });
};

var initArchiveItems = function initArchiveItems(items) {
  items.forEach(function (item) {
    item.style.opacity = "1";
  });
  archive.querySelectorAll('.archive__item__play').forEach(function (playButton) {
    archivePlayButtonClickEvent(playButton);
  });
};

var layoutArchiveItems = function layoutArchiveItems() {
  document.querySelector('.archive__loading').remove();
  msnry = new _masonryLayout.default(archive, {
...
var archivePlayButtonClickEvent = function archivePlayButtonClickEvent(playButton) {
  if (playButton.dataset.loaded) return;
  playButton.dataset.loaded = true;
  playButton.addEventListener('click', function (e) {
    var audioplayer = document.querySelector('.audioplayer--archive .audioplayer');
    var activeArchive = playButton.closest(".archive__item");
    e.preventDefault();

    if (_audioplayer.AudioPlayer === undefined) {
      (0, _audioplayer.initAudioPlayer)(audioplayer, activeArchive, true);
    } else {
      if (activeArchive === _audioplayer.AudioPlayer.activeArchive) {
        _audioplayer.AudioPlayer.waveform.playPause();
      } else {
        if (_audioplayer.AudioPlayer.waveform !== null) {
          _audioplayer.AudioPlayer.waveform.pause();

          _audioplayer.AudioPlayer.waveform.destroy();
...
if (archive != null) {
  (0, _imagesLoaded.default)(archive, layoutArchiveItems);

  if (document.body.classList.contains('template__home')) {
    loadPagination();
  }
}
},{"imagesLoaded":"../node_modules/imagesLoaded/imagesloaded.js","masonry-layout":"../node_modules/masonry-layout/masonry.js","infinite-scroll":"../node_modules/infinite-scroll/js/index.js","./audioplayer/audioplayer":"js/audioplayer/audioplayer.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"js/_project.js":[function(require,module,exports) {
"use strict";
...
// import $ from 'jquery';
document.querySelectorAll('.project__header').forEach(function (projectHeader) {
  var hiResImage = new Image();

  hiResImage.onload = function () {
    projectHeader.style.background = "url('".concat(hiResImage.src, "') no-repeat center center black");
  };
...
window.onload = function () {
  document.querySelectorAll(".audioplayer").forEach(function (audioplayer) {
    if (audioplayer.dataset.audio == false) {
      document.body.classList.add('no-track');
    } else {
      (0, _audioplayer.initAudioPlayer)(audioplayer, null, false);
    }
  });
};
},{"@fancyapps/fancybox":"../node_modules/@fancyapps/fancybox/dist/jquery.fancybox.js","./audioplayer/audioplayer":"js/audioplayer/audioplayer.js"}],"../node_modules/underscore/underscore.js":[function(require,module,exports) {
var global = arguments[3];
var define;
//     Underscore.js 1.9.1
...
var throttled = _underscore.default.throttle(updatePosition, 100);

window.addEventListener('scroll', throttled);
},{"underscore":"../node_modules/underscore/underscore.js"}],"../node_modules/jquery/dist/jquery.js":[function(require,module,exports) {
var global = arguments[3];
var process = require("process");
var define;
/*!
...
},{"process":"../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"js/_numbers.js":[function(require,module,exports) {
"use strict";
...
var numbers = function numbers(elem) {
  var elems = (0, _jquery.default)(elem);
...
require("./audioplayer/audioplayer");
},{"./_archive":"js/_archive.js","./_project":"js/_project.js","./_header":"js/_header.js","./_numbers":"js/_numbers.js","./audioplayer/audioplayer":"js/audioplayer/audioplayer.js"}]},{},["js/main.js"], null)
